...
class TabletDesignPage extends StatefulWidget {
  const TabletDesignPage({super.key});

  @override
  State<TabletDesignPage> createState() => _TabletDesignPageState();
}

class _TabletDesignPageState extends State<TabletDesignPage> {
  @override
            ...
            children: [
              Stack(
                children: [
                  ...
                  Positioned(
                      top: sizeWidth < 1200 ?  150 : 150,
                      left: 0,
                      child: FadeInRight(
                        child: SizedBox(
                            height: sizeWidth < 1200 ?  400 : 500,
                            child: Image.asset('assets/PNG/hoodie_men.png')),
                      )),
                          Positioned(
                      top: sizeWidth < 1200 ?  190 : 200,
                      left: sizeWidth < 1200 ?  250 : 300,
                      child: FadeInLeft(
                        child: SizedBox(
                            height: sizeWidth < 1200 ?  400 : 500,
                  ...
                  Positioned(
                    top: sizeWidth < 1200 ?  550 : 650,
                    left: sizeWidth<1200 ? 400 : 500,
                    right:sizeWidth<1200 ? 400 : 500,
                    child: FadeIn(
                  ...
                  Positioned(
                      top: sizeWidth < 1200 ?  150 : 170,
                      right: 0,
                      child: FadeInLeft(
                        child: SizedBox(
                            height: sizeWidth < 1200 ?  350 : 450,
              ...
              Padding(
                ...
                child: Stack(
                  children: [
                    ...
                    _button(text: 'Sweatshirt', sized: sizeWidth),
                  ],
                ),
              ),
              Padding(
                ...
                child: Stack(
                  children: [
                    ...
                    _button(text: 'Hoodies', sized: sizeWidth),
                  ],
                ),
              ),
              Padding(
                ...
                child: Stack(
                  children: [
                    ...
                    _button(text: 'Pair', sized: sizeWidth),
                  ],
                ),
              ),
              Padding(
...
Widget _button({required String text, required double sized}) {
  return Positioned(
    bottom: 30,
    left: sized < 1200 ? 400 : 550,
    right: sized < 1200 ? 400 : 550,
    child: Container(
      width: 200,
      height: 35,
      decoration: const BoxDecoration(
